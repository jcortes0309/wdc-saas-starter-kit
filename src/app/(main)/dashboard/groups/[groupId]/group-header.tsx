import { JoinGroupButton } from "@/app/(main)/dashboard/groups/[groupId]/join-group-button";
import { LeaveGroupButton } from "@/app/(main)/dashboard/groups/[groupId]/leave-group-button";
